...
static const _Angles_type_support_symbol_names_t _Angles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mpu6050_publisher, msg, Angles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mpu6050_publisher, msg, Angles)),
  }
};
...
{
  return &::mpu6050_publisher::msg::rosidl_typesupport_cpp::Angles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mpu6050_publisher, msg, Angles)() {
  return get_message_type_support_handle<mpu6050_publisher::msg::Angles>();
}
